...
class NavigationTest(BaseCase):
    ...
    def test_05_change_region(self):
        # 
        self.get(self.base_url+'/dolce-gabbana/s/1495')
        # получаем цену до смены языка и региона
        price_before = self.get_text('//article[1]/a/div[2]/p[3]')
        ...
        # получаем цену после смены языка и региона
        price_after = self.get_text('//article[27]/a/div[2]/p[3]')
        # цены не должны совпадать
